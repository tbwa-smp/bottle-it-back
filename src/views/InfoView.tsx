...
function CalendarIcon() {
	return (
		<svg viewBox="0 0 24 24" aria-hidden="true" className="info-view__nav-icon">
			<rect
				x="3"
				y="5"
				width="18"
			...
			<line
				...
				strokeLinecap="round"
			/>
			<line x1="8" y1="13" x2="8" y2="13" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
			<line x1="12" y1="13" x2="12" y2="13" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
			<line x1="16" y1="13" x2="16" y2="13" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
			<line x1="8" y1="17" x2="8" y2="17" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
			<line x1="12" y1="17" x2="12" y2="17" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
			<line x1="16" y1="17" x2="16" y2="17" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
		</svg>
	);
}
...
function BulbIcon() {
	return (
		<svg viewBox="0 0 24 24" aria-hidden="true" className="info-view__nav-icon">
			...
			/>
			<line x1="12" y1="2.5" x2="12" y2="1" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
			<line x1="4.4" y1="5.2" x2="3.2" y2="4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
			<line x1="19.6" y1="5.2" x2="20.8" y2="4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
			<line x1="2" y1="12" x2="0.8" y2="12" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
			<line x1="23.2" y1="12" x2="22" y2="12" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
		</svg>
	);
}
...
function InfoIcon() {
	return (
		<svg viewBox="0 0 24 24" aria-hidden="true" className="info-view__info-icon">
			<circle
				cx="12"
				cy="12"
				r="9"
...
export default function InfoView({ onGetStarted }: InfoViewProps) {
	...
	return (
		<section className="info-view">
			<div className="info-view__topbar">
				<button
					type="button"
					className="info-view__info-button"
					aria-label="About Bottle It Back"
				>
					<InfoIcon />
				</button>
			</div>
