			...
			<section className="welcome-view">
				...
				<div className="welcome-view__cta-wrapper">
					<div className="welcome-view__brand-block">
						...
						<img src={logo} alt="Bottle it back logo" style={{ width: "100%", maxWidth: "150px", height: "auto" }} />
					</div>
					<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', textAlign: 'center' }} >
						<p><strong>Your AI prompts cost water.</strong></p>
						<p style={{ width: '100%', maxWidth: '150px' }}>Track your AI footprint and give water back to communities in need.</p>
					</div>
					<div>
